...
async (conn, mek, m, { from, reply }) => {
    const githubRepoURL = 'https://github.com/NATSU-MD /NATSU-MD';
...
└──────────────────────┘
> *MADE IN BY NATSU BOY*`;

        await conn.sendMessage(from, {
            image: { url: ` https://files.catbox.moe/78tjg1.mp4 },
            caption: message,
            contextInfo: { 
                ...
                forwardedNewsletterMessageInfo: {
                    ...
                    newsletterName: config.OWNER_NAME || 'NATSU BOY TECH',
                    serverMessageId: 143
                }
            }
        }, { quoted: mek });
